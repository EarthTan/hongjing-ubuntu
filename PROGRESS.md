...
- [x] 9. 胜负判定 — engine/victory.py(GameResult 枚举 + compute_game_result/check_victory/has_yard/draw_game_over);World.game_result 字段 + tick 末尾自动 check_victory;玩家0建造厂死=DEFEAT,所有非玩家0建造厂死=VICTORY;main.py 终局时停 tick 不刷世界、ESC/鼠标点击返回菜单;18 个 headless 测试覆盖单/多AI/玩家缺失/双杀/tick 传播/渲染
- [ ] 10. 主菜单
